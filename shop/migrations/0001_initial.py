    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rated_current', models.IntegerField(default=0, verbose_name='Номинальный ток, А')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('temperature_range', models.IntegerField(default=1, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(1)], verbose_name='Диапазон температур, °C')),
                ('remote_sensor_wire_length', models.IntegerField(blank=True, default=3, verbose_name='Длина провода выносного датчика, м.')),
                ('temperature_hysteresis', models.FloatField(blank=True, default=0, verbose_name='Температурный гистерезис, °C')),
                ('maximum_load_current', models.IntegerField(blank=True, default=16, verbose_name='Максимальный ток нагрузки, А')),
                ('maximum_load_power', models.IntegerField(blank=True, default=3000, verbose_name='Максимальная мощность нагрузки, Вт')),
                ('correction_of_sensor_readings', models.IntegerField(blank=True, default=10, verbose_name='Коррекция показаний датчика, °C')),
                ('sensor_connection_diagnostics', models.BooleanField(blank=True, default=True, verbose_name='Диагностика подключения датчика')),
                ...
                ('num_of_programs', models.IntegerField(blank=True, default=0, verbose_name='Количество программ')),
                ('num_of_intervals_per_day', models.IntegerField(blank=True, default=2, verbose_name='Количество интервалов в сутки')),
                ('adaptive_function', models.BooleanField(blank=True, default=True, verbose_name='Адаптивная функция')),
                ('manual_mode', models.BooleanField(default=True, verbose_name='Ручной режим')),
                ('calculation_of_consumed_energy', models.BooleanField(blank=True, default=True, verbose_name='Расчет потребленной энергии')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('color', colorfield.fields.ColorField(blank=True, default='', image_field='image', max_length=18, samples=None, verbose_name='Цвет')),
